...
- Run at: 2026-09-21T15:20:39+00:00
- Tickets: 144
...
| Urgency accuracy | 99.3% |
| Escalation accuracy | 97.9% |
| All three correct | 94.4% |
...
Precision 0.8462, recall 0.9167. Reference escalation rate 8.3%, predicted 9.0%.
...
This run scored the **dev** split: 144 tickets carrying 12 reference escalations, of which 11 were caught and 1 missed, plus 2 escalations predicted that the reference does not have. 12 = 11 + 1.
...
|---|---:|---:|
| Accuracy | 99.3% | 73.6% (`low`, 73.6% of the reference) |
| Macro recall | 99.7% | 33.3% |

Accuracy gain over the constant predictor: **+25.7 points**.

| Urgency | Support | Predicted | Recall | Precision |
|---|---:|---:|---:|---:|
| `high` | 15 | 15 | 100.0% | 100.0% |
| `normal` | 23 | 24 | 100.0% | 95.8% |
| `low` | 106 | 105 | 99.1% | 100.0% |

## Cost and latency

- Total cost: **$0.1863** for 144 tickets
- Cost per ticket: $0.001294
- Latency: mean 2.34s, p50 2.14s, p95 3.33s (at 8 concurrent requests)
- Cache: 259688 input tokens served from cache, 5268 written
- Reasoning tokens: 426 (billed as output)

## Easy vs hard

| Slice | n | Intent | Urgency | Escalation |
|---|---:|---:|---:|---:|
| Bitext tickets | 126 | 94.4% | 99.2% | 98.4% |
| Authored hard cases | 18 | 100.0% | 100.0% | 94.4% |
...
| angry | 2 | 100% | 100% | 100% |
| high_value_refund | 2 | 100% | 100% | 50% |
| legal | 2 | 100% | 100% | 100% |
...
| account_access | account_management | 1 |
